...
public class MentorController extends AbstractController {
    ...
    public ResponseEntity<MentorDTO> getMentorById(@PathVariable Long id) {
        MentorDTO mentor = mentorService.getMentorProfile(id);
        return sendOkResponse(mentor);
    }

    @GetMapping("{id}/reviews")
    public ResponseEntity<List<MentorReviewResponseDTO>> getMentorReviews(@PathVariable Long id) {
        return sendOkResponse(mentorService.getMentorReviews(id));
    }
